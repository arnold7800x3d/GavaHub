...
class PassportSecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_passport_second, container, false)


        binding.passport2Nextbutton3.setOnClickListener{
            it.findNavController().navigate(R.id.action_passportSecondFragment_to_passportThirdFragment)
        }
        return binding.root
    }
}