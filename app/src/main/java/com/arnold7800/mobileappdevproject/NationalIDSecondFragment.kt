...
class NationalIDSecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_national_i_d_second, container, false)

        //button on click event
        binding.id2Nextbutton3.setOnClickListener{
            it.findNavController().navigate(R.id.action_nationalIDSecondFragment_to_nationalIDPaymentFragment)
        }
        return binding.root
    }
}